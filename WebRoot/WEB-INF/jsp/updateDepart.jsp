...
<body bgcolor="E7F2FF">
  ...
  <div id="main">
    <form name="formupdateDepart" method="get" action = "updateDepartment.jsp">
  ...
  <tr>
    <td align="center">请输入您要修改的部门编号</td>
    </tr>
    <tr>
    <td align="center"><input type="text" name="departNumber" class="text"></td>
  </tr>
